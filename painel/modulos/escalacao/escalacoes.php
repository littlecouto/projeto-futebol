...
<div class="formulario"  style="width: 100%;">
	...
	$inicial = $pg * $numreg;
    $result = mysql_query("SELECT T.idTim, T.apelido, (SELECT SUM(J.forca) FROM jogador J, jogador_time C WHERE T.idTIm=C.idTim AND C.idJgd=J.idJgd) as FORCAS FROM times T ORDER BY FORCAS DESC, apelido LIMIT $inicial, $numreg") or die(mysql_error().' na linha '.__LINE__);
    ...
    <table class="listagem" width="100%" border="0" cellpadding="3" cellspacing="0">
        ...
        while($row = mysql_fetch_array($result)){
            ...
            echo "	<tr>
                    ...
                    <td> $row[apelido] </td>
                    <td><a href='escalar.php?time=$row[idTim]'><img src='../../include/img/bt/bt_alterar.gif' alt='Alterar Registro' title='Alterar Registro' border='0' /></a></td>
