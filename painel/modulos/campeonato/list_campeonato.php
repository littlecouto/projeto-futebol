...
<div class="formulario"  style="width: 100%;">
    ...
    ?>
    <form action="list_campeonato.php" method="get">
    <select name="d">
    ...
    <table class="listagem" width="100%" border="0" cellpadding="3" cellspacing="0">
        <tr>
        <td width="20%" class="t_campo">TEMPORADA</td>
        <td width="55%" class="t_campo">DIVISÃO</td>
        ...
        while($row = mysql_fetch_array($result)){
            ...
            echo "	<tr>
                    ...
                    <td> $row[divisao] </td>
                    <td> <a href='jogos_campeonato.php?t=$row[temporada]&amp;d=$row[divisao]'>Jogos</a> </td>
                    <td><a href='info_campeonato.php?t=$row[temporada]&amp;d=$row[divisao]'><img src='../../include/img/bt/bt_alterar.gif' alt='Alterar Registro' title='Alterar Registro' border='0' /></a></td>
                    </tr>";
        }
