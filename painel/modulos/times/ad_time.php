...
<div class="formulario">
	...
	<div class="area">
        ...
        <div class="campo"> <label> <input name="nome" type="text" maxlength="100" onblur="this.value=this.value.toUpperCase()" /> </label> <br />
        </div>
      </div>
        ...
        <div class="campo"> <label> <input name="apelido" type="text" maxlength="50" onblur="this.value=this.value.toUpperCase()" /> </label> <br />
        </div>
      </div>
        ...
        <div class="campo"> <label> <input name="cor_prin" type="color" maxlength="7" value="#FFFFFF" onblur="this.value=this.value.toUpperCase()" /> </label> <br />
        </div>
      </div>
      
        <div class="linha">
          <div class="t_campo">*COR SECUNDÁRIA</div>
        <div class="campo"> <label> <input name="cor_sec" type="color" maxlength="7" value="#FFFFFF" onblur="this.value=this.value.toUpperCase()" /> </label> <br />
        </div>
      </div>
      
        <div class="linha">
          <div class="t_campo">*COR TERCEÁRIA</div>
        <div class="campo"> <label> <input name="cor_ter" type="color" maxlength="7" value="#FFFFFF" onblur="this.value=this.value.toUpperCase()" /> </label> <br />
        </div>
      </div>
