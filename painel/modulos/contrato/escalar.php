...
<div class="formulario">
	...
	<div class="area">
        ...
        <div class="campo"> <label>
        		<?php 
        			$resLoc = mysql_query("SELECT j.apelido, j.idJgd, j.forca, j.idPos FROM jogador j INNER JOIN jogador_time c ON j.idJgd=c.idJgd INNER JOIN times t ON c.idTim=t.idTim WHERE t.idTim=$_GET[time] AND j.idPos<6 ORDER BY idPos, forca DESC") or die(mysql_error());
